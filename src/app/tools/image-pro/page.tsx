  ...
  return (
    <main className="pt-32 pb-20 px-6 min-h-screen flex flex-col items-center">
      <section className="max-w-4xl mx-auto text-center mb-12">
        ...
        >
          <Zap size={12} fill="currentColor" /> Local AI Engine
        </motion.div>
        ...
        >
          QUICK<span className="text-primary italic">IMAGE PRO.</span>
        </motion.h1>
        ...
        >
          Remove image backgrounds locally and securely in your browser using
          industrial-grade AI segmentation.
        </motion.p>
      </section>
